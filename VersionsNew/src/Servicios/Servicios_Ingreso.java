...
public class Servicios_Ingreso {
    ...
    public void create(Connection conexion, Ingreso ingreso) throws SQLException{
        try{
            ...
            consulta.setString(2, ingreso.getFecha());
    ...
    public Ingreso getById(Connection conexion, int codigoI) throws SQLException{
        ...
        try{
            ...
            while(resultado.next()){
                ingreso = new Ingreso(codigoI, resultado.getInt("habitacion"), resultado.getString("fecha"), resultado.getInt("codigo_m"), resultado.getInt("codigo_p"));
            }
        }catch(SQLException ex){
            throw new SQLException(ex);
        }
    ...
    public List<Ingreso> getAll(Connection conexion) throws SQLException{
        ...
        try{
            ...
            ResultSet resultado = consulta.executeQuery();
            while(resultado.next()){
                ingresos.add(new Ingreso(resultado.getInt("codigoI"), resultado.getInt("habitacion"), resultado.getString("fecha"), resultado.getInt("codigo_m"), resultado.getInt("codigo_p")));
            }
        }catch(SQLException ex){
            throw new SQLException(ex);
        }
